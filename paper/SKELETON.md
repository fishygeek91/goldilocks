...
| C14 | PB-native EXACT deep-shell proposal cost vs n (M06, correct states, Exact solver, full enumeration + uniform pick): 1.3–3.5 s (n=16) → 31–47 s (n=20) → censored ≥300 s in 11/12 deep cells at n=24–32 (≥10×/4 spins); vs quench ~1e-2 s: 3.5 orders at n=20, ≥4.5 widening from n=24; mechanism = completeness proof of a near-empty window; kill (≤0.1 s through n=32) not met | M06 (tunnelvision experiments/M06_pbnative/, pre-registered README) | MEASURED (2 seeds, censoring explicit) |
| C15 | Free-Certificate theorem: (a) any composition of Q-commuting unitaries + Q-commuting-Kraus noise keeps outcomes in the start sector of a diagonal charge Q w.p. 1 (commutant algebra); (b) + Thm-lindblad hypotheses ⇒ per-sector proposal symmetry, logq≡0 MH valid on the sector; certified n=6 XY+disorder full Lindblad (leakage exactly 0, symmetry defect 1.9e-16). (c) post-selection preserving symmetry = CONJECTURE (state-dependent discard prob, same mechanism as T1), NOT claimed | tunnelvision/docs/free_certificate.md + free_certificate_cert.py | PROVEN (a,b) / CONJECTURE (c), 2026-09-14 |
| C16 | P01 PORTAL registered negative: A3 acceptance gate passed (8/8 cells ≥0.2 at n≤20); K1 fired — classical miners (greedy+kick, PT-ICM) match/beat simulated-quench mode coverage 24/24 cells at n≥16 at matched builder budget (quench overran budget 3–50×); K2 fired — darting gain 0.46–1.75× < 2× over PT baseline on 6/12 metastability-screened cells at n=50–200; mechanisms: solver member-finding starves at n≥50 dense (bounds C13/C14 "finding is cheap" to n≤32), portal acceptance ≲0.01 at scale; K1-at-scale undecidable in simulation | P01 (tunnelvision experiments/P01_portal/, pre-registered README) | MEASURED, BOTH KILLS FIRED 2026-09-14 |
