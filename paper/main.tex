...
energy window complete --- a proof a physical sampler never performs. Noise costs nothing and buys nothing; the
...
uniformly), and that completeness proof is what scales. With the native
...
scan in \texttt{tunnelvision/experiments/M06\_pbnative/}). A public archival deposit will be made at submission
(TODO: ZENODO-DOI).
